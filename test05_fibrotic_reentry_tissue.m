...
phie = igb_data('/Volumes/Daten/Benutzer/pt732/Experiments/05_fibrotic_reentry_case/simulations_d500/16x16/tissue_ints_10_f1/2021-07-19_basic_2000.0/phie_recovery.igb', 'all', 'all');
...
RT_reconstruction_pos = RT_reconstruction(distance_pos_min);
...
% RMSE
RMSE_AT = sqrt((AT_reconstruction_pos - AT_groundtruth).^2);
RMSE_RT = sqrt((RT_reconstruction_pos - RT_groundtruth).^2);
...
%%
% filename = 'case_reentry_fibrotic_12x12_60.xlsx';
% 
...
qtrip(comb.points, comb.cells, Xm, 1041, [0 90 90], 1, [-100 100], 10);
pause(0.5)
...
%%
[singularity_points] = singularity_points_function(Xm, vtk_coarse);
%%
