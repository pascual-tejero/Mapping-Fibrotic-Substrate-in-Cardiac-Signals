...
phie = igb_data('/Volumes/Daten/Benutzer/pt732/Experiments/01_control_case/08_Simulations_parameters/r02_d1000_e8x8/2021-06-10_basic_1000.0/phie_recovery.igb', 'all', 'all');
...
%%
% filename = 'control_case_16x16_d1000.xlsx';
% 
...
qtrip(comb.points, comb.cells, Xm, 1041, [0 90 90], 0.5, [round(min(min(Xm))) round(max(max(Xm)))], 1);
pause(0.5)
