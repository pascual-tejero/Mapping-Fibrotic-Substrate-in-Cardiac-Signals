...
def run(args, job):
    ...
    meshname = '/Volumes/yellow/Benutzer/pt732/tissue_ints_60_2'
    ...
    regelec = mesh.BoxRegion((-23,-23,-0.1), (23,23,0.1), tag=0)
    ...
    points_text[:,2] = points_text[:,2] + 2500 #It is added the position of the 3rd column of the file to 550 µm
    #print(points_text)
    ...
    #Saving the state in the time 1000, in order to do properly the simulation
    savestate = ['-num_tsav',1,
                '-tsav[0]',1000,
                '-write_statef',"state_t1000_ints_10_10",]
