...
def run(args, job):
    ...
    meshname = '/Volumes/red/Benutzer/pt732/tissue_ints_10_f1'
    ...
    points_text[:,2] = points_text[:,2] + 3800 #It is added the position of the 3rd column of the file to 550 µm
    #print(points_text)
